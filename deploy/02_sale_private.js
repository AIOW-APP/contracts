...
module.exports = async (hre) => {
  ...
  const cfg = config[hre.network.name].tokensales.private;
  ...
  const deployedAddress = (await deployments.get('TokenSalePrivate')).address;
...
module.exports.tags = ['PrivateSale'];
